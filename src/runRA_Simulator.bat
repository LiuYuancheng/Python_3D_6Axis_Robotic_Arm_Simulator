echo "Running Robot_arm_simulator [robotArmSimulator.py] under python vEnv3.9"
@echo off
REM Enable the virtual environment, replace the vEnv3.9 with the vEnv you configured.
call workon vEnv3.9
